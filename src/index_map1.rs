...
impl<'a, K, V> OccupiedEntry<'a, K, V> {
    ...
    pub fn shift_remove_entry_if_many(self) -> OrOnlyEntry<'a, K, V, (K, V)> {
        self.map_many(index_map::OccupiedEntry::shift_remove_entry)
    }

    pub fn swap_remove_entry_if_many(self) -> OrOnlyEntry<'a, K, V, (K, V)> {
        self.map_many(index_map::OccupiedEntry::swap_remove_entry)
    }

    pub fn shift_remove_if_many(self) -> OrOnlyEntry<'a, K, V, V> {
        self.map_many(index_map::OccupiedEntry::shift_remove)
    }

    pub fn swap_remove_if_many(self) -> OrOnlyEntry<'a, K, V, V> {
...
impl<'a, K, V> IndexedEntry<'a, K, V> {
    ...
    pub fn shift_remove_entry_if_many(self) -> OrIndexedOnlyEntry<'a, K, V, (K, V)> {
        match self {
            One(only) => One(only),
    ...
    pub fn swap_remove_entry_if_many(self) -> OrIndexedOnlyEntry<'a, K, V, (K, V)> {
        match self {
            One(only) => One(only),
    ...
    pub fn shift_remove_if_many(self) -> OrIndexedOnlyEntry<'a, K, V, V> {
        match self {
            One(only) => One(only),
    ...
    pub fn swap_remove_if_many(self) -> OrIndexedOnlyEntry<'a, K, V, V> {
        match self {
            One(only) => One(only),
